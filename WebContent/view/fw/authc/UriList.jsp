...
<!--
	$(function() {
		...
		parent.resize(doResize);

		// 		parent.resizable({
		// 			resize : function(event, ui) {
		// 				alert("asdf");
		// 				grid.setGridWidth(parent.width());
		// 				grid.setGridHeight(parent.height());
		// 			}
		// 		});
		...
		// 			grid.setGridWidth(parent.width());
		// 			grid.setGridHeight(parent.height());
		// 			parent.bind("onresize", this);
		// 		});

		doResize();

		function doResize() {
			grid.setGridWidth(parent[0].clientWidth - 10);
			grid.setGridHeight(parent[0].clientHeight - 94);
		}
